...
def write_file(new_contents):
    with open("README-vercel.md") as f:
        #去除标题
        for _ in range(7):
            f.readline()
...
def craw_all():
    ...
    api = "https://api.github.com/search/repositories?q=vercel-{}&sort=updated&per_page=100&page={}"
    item_list = []
...
def get_info(year):
    ...
    try:
        ...
        api = "https://api.github.com/search/repositories?q=vercel-{}&sort=updated".format(
            year)
        # 请求API
